                                                ...
                                                <form name="basic" method="POST" action="questions.php">
                                                        <table class="table table-condensed" style="border: 1px solid #dddddd; border-radius: 5px; box-shadow: 2px 2px 10px;">
                                                               ...
                                                               // <tr><td></td><input type="hidden" name="id" value=' . $row[0] . '" size"10"></td></tr>
                                                                <tr><td>ID: </td><td><input type="edit" name="id" value="' . $row[1] . '" size="20"></td></tr>
															   <tr><td>Quiz Name: </td><td><input type="edit" name="quizzes_id" value="' . $row[2] . '" size="20"></td></tr>
                                                                <tr><td>Question: </td><td><input type="edit" name="question" value="' . $row[3] . '" size="50"></td></tr>';
...
function displayTable($mysqli)
{
        echo         '<div class="col-md-12"><form action="questions.php" method="POST"><table class="table table-condensed" style="border: 1px solid #dddddd; border-radius: 5px; box-shadow: 2px 2px 10px;">
                        ...
                        <tr style="font-weight:800; font-size:20px;"><td>ID</td><td>Quiz Id</td><td>Question</td>';
        ...
        //if($_SESSION['user'] != "")
        {
                echo '<a href="InsertQuestions.php" class="btn btn-primary">Add an Entry</a><br></div>';
        }
...
function insertRecord($mysqli)
{
    ...
    if($stmt = $mysqli->prepare("INSERT INTO $usertable (id,quizzes_id,question) VALUES (NULL, '$quizzes_id', '$question')"))
    {
            ...
            //$stmt->bind_param('sssssssii', $id, $quizzes_id, $question, $_SESSION['id'], $lid);
            /* execute prepared statement */
            $stmt->execute();
            /* close statment */
            $stmt->close();
...
{
         global $id, $quizzes_id, $question, $index, $lid, $usertable;
    ...
    {
            /* Bind parameters. Types: s = string, i = integer, d = double,  b = blob, etc... */
            //$stmt->bind_param('sssssssiii', $id, $quizzes_id, $question, $_SESSION['id'], $lid, $index);
            /* execute prepared statement */
            $stmt->execute();
            /* close statment */
            $stmt->close();
                        ...
                        echo '        <br>
                                        ...
                                        <form name="basic" method="POST" action="questions.php">
                                                <table class="table table-condensed" style="border: 1px solid #dddddd; border-radius: 5px; box-shadow: 2px 2px 10px;">
                                                        ...
                                                        <tr><td><b>ID: </b></td><td>' . $row[1] . '</td></tr>
                                                        <tr><td><b>Quiz Id: </b></td><td>'. $row[2] . '</td></tr>
                                                        <tr><td><b>Question: </b></td><td>' . $row[3] . '</td></tr>
